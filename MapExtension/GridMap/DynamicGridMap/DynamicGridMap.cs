...
namespace VMFramework.Maps
{
    public abstract partial class DynamicGridMap : IGridMap
    {
        ...
        public bool TryCreateChunk(Vector3Int position, out IGridChunk chunk)
        {
            ...
            {
                UnityEngine.Debug.LogError($"Position {position} is outside the chunk bounds: {config.chunkBounds}. " +
            ...
            {
                UnityEngine.Debug.LogError($"Chunk at position {position} already exists. Cannot create new chunk.");
                chunk = null;
                return false;
            }
        ...
        public void DestructChunk(Vector3Int position)
        {
            ...
            {
                throw new InvalidOperationException($"Chunk at position {position} does not exist. Cannot destroy chunk.");
            }
