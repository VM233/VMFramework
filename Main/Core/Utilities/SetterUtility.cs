    ...
    public static class SetterUtility
    {
            ...
            where TValue : class
        {
            if (oldValue == null)
            {
                if (newValue == null)
                {
                    UnityEngine.Debug.LogWarning($"The {valueName} of {owner} has already been set to null." +
            ...
            UnityEngine.Debug.LogWarning($"The {valueName} of {owner} has already been set to {oldValue} and cannot be changed." +
            ...
            where TValue : struct, IEquatable<TValue>
        {
            ...
            UnityEngine.Debug.LogWarning($"The {valueName} of {owner} has already been set to {oldValue} " +
