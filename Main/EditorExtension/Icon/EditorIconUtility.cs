...
namespace VMFramework.Editor
{
    ...
    {
        public static void Add(this OdinMenuTree tree, string path, object instance, EditorIcon icon)
        {
        ...
        public static bool IsNull(this EditorIcon icon)
        {
            switch (icon.iconType)
            {
                case EditorIconType.Sprite:
        ...
        public static Texture GetTexture(this EditorIcon icon)
        {
