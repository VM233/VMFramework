    ...
    public static class GamePrefabWrapperCreator
    {
            ...
            where TWrapper : GamePrefabWrapper
        {
            ...
            if (path.ExistsAsset())
            {
                ...
                {
                    UnityEngine.Debug.LogWarning($"Asset already exists at {path}.");
                    return null;
                }
                ...
                {
                    UnityEngine.Debug.LogWarning($"{typeof(TWrapper).Name} already exists at {path} " +
            ...
            {
                UnityEngine.Debug.LogError($"No {nameof(IGamePrefab)} provided to create {typeof(TWrapper).Name}.");
                return null;
            }
            ...
            if (gamePrefabWrapper == null)
            {
                ...
                if (gamePrefabWrapper == null)
                {
                    UnityEngine.Debug.LogError($"Could not create {typeof(TWrapper).Name} " +
