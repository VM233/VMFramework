...
namespace VMFramework.GameLogicArchitecture
{
    public static partial class GamePrefabManager
    {
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IEnumerable<string> GetAllIDs<T>()
            where T : IGamePrefab
        {
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IEnumerable<string> GetAllActiveIDs<T>()
            where T : IGamePrefab
        {
            foreach (var (id, prefab) in allGamePrefabsByID)
            {
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T GetGamePrefab<T>(string id)
            where T : IGamePrefab
        {
            if (id == null)
            {
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T GetActiveGamePrefab<T>(string id)
            where T : IGamePrefab
        {
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool TryGetActiveGamePrefab<T>(string id, out T targetPrefab)
            where T : IGamePrefab
        {
            if (TryGetActiveGamePrefab(id, out var prefab) == false)
            {
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IEnumerable<T> GetAllActiveGamePrefabs<T>()
            where T : IGamePrefab
        {
            foreach (var prefab in allGamePrefabsByID.Values)
            {
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IGamePrefab GetRandomGamePrefab(Random random)
        {
            return random.ChooseOrDefault(allGamePrefabsByID.Values);
        }
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T GetRandomGamePrefab<T>(Random random)
            where T : IGamePrefab
        {
            return random.ChooseOrDefault(GetAllGamePrefabs<T>());
        }
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsGamePrefab<T>(string id)
            where T : IGamePrefab
        {
            if (id.IsNullOrEmpty())
            {
        ...
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool ContainsActiveGamePrefab<T>(string id)
            where T : IGamePrefab
        {
            if (id.IsNullOrEmpty())
            {
