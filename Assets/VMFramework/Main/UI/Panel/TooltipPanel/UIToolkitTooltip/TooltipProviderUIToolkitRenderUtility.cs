...
{
    public static class TooltipProviderUIToolkitRenderUtility
    {
        ...
        public static RenderResult RenderToVisualElement(this ITooltipProvider tooltipProvider, Label titleLabel,
            Label descriptionLabel, VisualElement propertyContainer,
            Action<VisualElement, VisualElement> addVisualElementAction = null)
        {
            ...
            void AddPropertyEntry(TooltipPropertyInfo propertyConfig)
            {
                ...
                {
                    if (groups.TryGetValue(propertyConfig.groupName, out var group) == false)
                    {
