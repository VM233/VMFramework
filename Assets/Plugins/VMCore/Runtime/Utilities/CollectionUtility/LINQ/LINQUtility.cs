...
namespace VMFramework.Core.Linq
{
    public static partial class LINQUtility
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T FirstNotNull<T>(this IEnumerable<T> enumerable) where T : class
        {
            return enumerable.FirstOrDefault(item => item != null);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T FirstNotUnityNull<T>(this IEnumerable<T> enumerable) where T : class
        {
            return enumerable.FirstOrDefault(item => item.IsUnityNull() == false);
        }
